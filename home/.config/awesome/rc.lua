...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "1", "2", "3", "4", "5", "6", "7", "8", "9" }, s, awful.layout.layouts[2])    -- SSR: sets the default layout here to [2](tile)
...
awful.rules.rules = {
    ...
    -- beurk, will nicht -- -- Add titlebars to normal clients and dialogs
    -- beurk, will nicht -- { rule_any = {type = { "normal", "dialog" }
    -- beurk, will nicht --   }, properties = { titlebars_enabled = true }
    -- beurk, will nicht -- },
